class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
<blackquote> Mʏ Nᴀᴍᴇ Is <a href=https://t.me/{}>{}</a></blackquote>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs, Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ Aɴᴅ Eɴᴊᴏʏ 😍</b>"""
...
✯ Lᴀɴɢᴜᴀɢᴇ: Pʏᴛʜᴏɴ 3.5
✯ DᴀᴛᴀBᴀsᴇ: Mᴏɴɢᴏ Db
✯ Bᴏᴛ Sᴇʀᴠᴇʀ: Pʏᴛʜᴏɴ Turbo
✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: V5 [ Highly Sᴛᴀʙʟᴇ ]</b>"""
