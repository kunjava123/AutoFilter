...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1001752414571').split() if id_pattern.search(auth_channel)]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+UWSM7s5H-r40Nzhl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+UWSM7s5H-r40Nzhl')
