...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002223719727 -1002058292472').split() if id_pattern.search(auth_channel)]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_kottaaram')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mk_movies_linkz')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mk_support_group')
