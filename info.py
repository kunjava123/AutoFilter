...
BOT_USERNAME = environ.get("BOT_USERNAME", "Mallubotbotbotbotbotbotmallubot")
BOT_NAME = environ.get("BOT_NAME", "❟❛❟ ᴍʀ_ʟᴜғғʏ ❟❛❟™◢ ◤")
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002116310726 -1001752414571').split() if id_pattern.search(auth_channel)]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/new_movies_group2')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Malayalam_New_Cinemas')
